...
if __name__ == "__main__":
    ...
    delta_charge_density_same_sublattice_sites = [
        charge_density(lam, fermi_energy, m, m, s1, s1) for m in distances
    ]
    delta_charge_density_opp_sublattice_sites = [
        charge_density(lam, fermi_energy, m, m, s1, s2) for m in distances
    ]
